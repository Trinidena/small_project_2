...
plot_clusters(X_scaled, kmeans_labels, centroids=kmeans.cluster_centers_, title='K-means Clustering with Centroids')
...
# Visualize DBSCAN on moons dataset
plt.scatter(X_moons[:, 0], X_moons[:, 1], c=dbscan_labels, cmap='viridis', marker='o', edgecolor='k', s=50)
